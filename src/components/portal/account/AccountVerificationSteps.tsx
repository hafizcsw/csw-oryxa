  ...
  return (
    <div className="space-y-4" dir={isRtl ? "rtl" : "ltr"}>
      ...
      <Dialog open={whyOpen} onOpenChange={setWhyOpen}>
        <DialogContent
          dir={isRtl ? "rtl" : "ltr"}
          className="sm:max-w-md w-[calc(100vw-2rem)] [&>button]:top-4 [&>button]:end-4 [&>button]:start-auto"
        >
          ...
          <ul className="space-y-4 py-2">
            {[
              { title: 'portal.steps.whyVerifyPoint1Title', body: 'portal.steps.whyVerifyPoint1Body' },
              { title: 'portal.steps.whyVerifyPoint2Title', body: 'portal.steps.whyVerifyPoint2Body' },
              { title: 'portal.steps.whyVerifyPoint3Title', body: 'portal.steps.whyVerifyPoint3Body' },
            ].map(({ title, body }) => (
          ...
          <DialogFooter>
            <Button onClick={() => setWhyOpen(false)} variant="outline" className="w-full sm:w-auto">
