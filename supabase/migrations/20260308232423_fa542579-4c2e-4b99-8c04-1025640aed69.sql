-- Add title_ar to programs
ALTER TABLE public.programs ADD COLUMN IF NOT EXISTS title_ar TEXT;

-- Add name_ar to degrees
ALTER TABLE public.degrees ADD COLUMN IF NOT EXISTS name_ar TEXT;

-- Recreate vw_program_details with locale columns
