...
-- 1) Fix university_offices unique constraint for ON CONFLICT
ALTER TABLE public.university_offices
  ADD CONSTRAINT uq_university_offices_type UNIQUE (university_id, office_type);

-- 2) Fix rpc_publish_university_contacts: o.value → o.value_raw
...
-- 3) Fix rpc_publish_university_offices: o.value → o.value_raw
