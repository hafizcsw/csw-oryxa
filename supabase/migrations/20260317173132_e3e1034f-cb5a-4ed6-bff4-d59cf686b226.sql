...
BEGIN
  ...
  -- ============ SINGLE FUNNEL (legacy combined) ============
  SELECT jsonb_build_array(
    jsonb_build_object('step','landing','step_order',1,'identity_domain','visitor_id','count_source','events','visitors',(SELECT count(distinct visitor_id) FROM events WHERE created_at >= _cutover AND COALESCE(traffic_class,'real') IN ('real','known_real') AND COALESCE(is_admin,false)=false AND COALESCE(is_test,false)=false AND COALESCE(is_staff,false)=false AND created_at >= now()-interval '30 days' AND name IN ('page_view','landing') AND route = '/')),
    jsonb_build_object('step','search','step_order',2,'identity_domain','visitor_id','count_source','events','visitors',(SELECT count(distinct visitor_id) FROM events WHERE created_at >= _cutover AND COALESCE(traffic_class,'real') IN ('real','known_real') AND COALESCE(is_admin,false)=false AND COALESCE(is_test,false)=false AND COALESCE(is_staff,false)=false AND created_at >= now()-interval '30 days' AND (name = 'search_performed' OR route LIKE '/search%'))),
    jsonb_build_object('step','university_view','step_order',3,'identity_domain','visitor_id','count_source','events','visitors',(SELECT count(distinct visitor_id) FROM events WHERE created_at >= _cutover AND COALESCE(traffic_class,'real') IN ('real','known_real') AND COALESCE(is_admin,false)=false AND COALESCE(is_test,false)=false AND COALESCE(is_staff,false)=false AND created_at >= now()-interval '30 days' AND name = 'entity_view' AND properties->>'entity_type' = 'university')),
    jsonb_build_object('step','program_view','step_order',4,'identity_domain','visitor_id','count_source','events','visitors',(SELECT count(distinct visitor_id) FROM events WHERE created_at >= _cutover AND COALESCE(traffic_class,'real') IN ('real','known_real') AND COALESCE(is_admin,false)=false AND COALESCE(is_test,false)=false AND COALESCE(is_staff,false)=false AND created_at >= now()-interval '30 days' AND name = 'entity_view' AND properties->>'entity_type' = 'program')),
    jsonb_build_object('step','shortlist','step_order',5,'identity_domain','visitor_id','count_source','events','visitors',(SELECT count(distinct visitor_id) FROM events WHERE created_at >= _cutover AND COALESCE(traffic_class,'real') IN ('real','known_real') AND COALESCE(is_admin,false)=false AND COALESCE(is_test,false)=false AND COALESCE(is_staff,false)=false AND created_at >= now()-interval '30 days' AND name = 'shortlist_add')),
    jsonb_build_object('step','register_start','step_order',6,'identity_domain','visitor_id','count_source','events','visitors',(SELECT count(distinct visitor_id) FROM events WHERE created_at >= _cutover AND COALESCE(traffic_class,'real') IN ('real','known_real') AND COALESCE(is_admin,false)=false AND COALESCE(is_test,false)=false AND COALESCE(is_staff,false)=false AND created_at >= now()-interval '30 days' AND name = 'register_start')),
    jsonb_build_object('step','register_complete','step_order',7,'identity_domain','user_id','count_source','profiles','visitors',(SELECT count(*) FROM profiles WHERE created_at >= now()-interval '30 days')),
    jsonb_build_object('step','apply_click','step_order',8,'identity_domain','application_id','count_source','applications','visitors',(SELECT count(*) FROM applications WHERE created_at >= now()-interval '30 days')),
    jsonb_build_object('step','doc_upload','step_order',9,'identity_domain','application_id','count_source','application_documents','visitors',(SELECT count(distinct application_id) FROM application_documents WHERE created_at >= now()-interval '30 days')),
    jsonb_build_object('step','payment','step_order',10,'identity_domain','visitor_id','count_source','events','visitors',(SELECT count(distinct visitor_id) FROM events WHERE created_at >= _cutover AND COALESCE(traffic_class,'real') IN ('real','known_real') AND COALESCE(is_admin,false)=false AND COALESCE(is_test,false)=false AND name = 'payment_complete' AND created_at >= now()-interval '30 days'))
  ) INTO _funnel;

  -- ============ 3 FUNNELS ============
  SELECT jsonb_build_array(
    -- DISCOVERY: all visitor_id from events
    jsonb_build_object('name','discovery','steps', jsonb_build_array(
      jsonb_build_object('step','landing','step_order',1,'identity_domain','visitor_id','count_source','events','visitors',(SELECT count(distinct visitor_id) FROM events WHERE created_at >= _cutover AND COALESCE(traffic_class,'real') IN ('real','known_real') AND COALESCE(is_admin,false)=false AND COALESCE(is_test,false)=false AND COALESCE(is_staff,false)=false AND created_at >= now()-interval '30 days' AND name IN ('page_view','landing') AND route = '/')),
      jsonb_build_object('step','search_page','step_order',2,'identity_domain','visitor_id','count_source','events','visitors',(SELECT count(distinct visitor_id) FROM events WHERE created_at >= _cutover AND COALESCE(traffic_class,'real') IN ('real','known_real') AND COALESCE(is_admin,false)=false AND COALESCE(is_test,false)=false AND COALESCE(is_staff,false)=false AND created_at >= now()-interval '30 days' AND route LIKE '/search%')),
      jsonb_build_object('step','search_performed','step_order',3,'identity_domain','visitor_id','count_source','events','visitors',(SELECT count(distinct visitor_id) FROM events WHERE created_at >= _cutover AND COALESCE(traffic_class,'real') IN ('real','known_real') AND COALESCE(is_admin,false)=false AND COALESCE(is_test,false)=false AND COALESCE(is_staff,false)=false AND created_at >= now()-interval '30 days' AND name = 'search_performed')),
      jsonb_build_object('step','university_view','step_order',4,'identity_domain','visitor_id','count_source','events','visitors',(SELECT count(distinct visitor_id) FROM events WHERE created_at >= _cutover AND COALESCE(traffic_class,'real') IN ('real','known_real') AND COALESCE(is_admin,false)=false AND COALESCE(is_test,false)=false AND COALESCE(is_staff,false)=false AND created_at >= now()-interval '30 days' AND name = 'entity_view' AND properties->>'entity_type' = 'university')),
      jsonb_build_object('step','program_view','step_order',5,'identity_domain','visitor_id','count_source','events','visitors',(SELECT count(distinct visitor_id) FROM events WHERE created_at >= _cutover AND COALESCE(traffic_class,'real') IN ('real','known_real') AND COALESCE(is_admin,false)=false AND COALESCE(is_test,false)=false AND COALESCE(is_staff,false)=false AND created_at >= now()-interval '30 days' AND name = 'entity_view' AND properties->>'entity_type' = 'program')),
      jsonb_build_object('step','shortlist','step_order',6,'identity_domain','visitor_id','count_source','events','visitors',(SELECT count(distinct visitor_id) FROM events WHERE created_at >= _cutover AND COALESCE(traffic_class,'real') IN ('real','known_real') AND COALESCE(is_admin,false)=false AND COALESCE(is_test,false)=false AND COALESCE(is_staff,false)=false AND created_at >= now()-interval '30 days' AND name = 'shortlist_add'))
    )),
    -- ACCOUNT: mixed sources, labels honest
    jsonb_build_object('name','account','steps', jsonb_build_array(
      jsonb_build_object('step','register_start','step_order',1,'identity_domain','visitor_id','count_source','events','visitors',(SELECT count(distinct visitor_id) FROM events WHERE created_at >= _cutover AND COALESCE(traffic_class,'real') IN ('real','known_real') AND COALESCE(is_admin,false)=false AND COALESCE(is_test,false)=false AND COALESCE(is_staff,false)=false AND created_at >= now()-interval '30 days' AND name = 'register_start')),
      jsonb_build_object('step','register_complete','step_order',2,'identity_domain','user_id','count_source','profiles','visitors',(SELECT count(*) FROM profiles WHERE created_at >= now()-interval '30 days')),
      jsonb_build_object('step','account_open','step_order',3,'identity_domain','visitor_id','count_source','events','visitors',(SELECT count(distinct visitor_id) FROM events WHERE created_at >= _cutover AND COALESCE(traffic_class,'real') IN ('real','known_real') AND COALESCE(is_admin,false)=false AND COALESCE(is_test,false)=false AND created_at >= now()-interval '30 days' AND name = 'account_open')),
      jsonb_build_object('step','service_step_open','step_order',4,'identity_domain','visitor_id','count_source','events','visitors',(SELECT count(distinct visitor_id) FROM events WHERE created_at >= _cutover AND COALESCE(traffic_class,'real') IN ('real','known_real') AND COALESCE(is_admin,false)=false AND COALESCE(is_test,false)=false AND created_at >= now()-interval '30 days' AND name = 'service_step_open'))
    )),
    -- REVENUE: mixed sources, labels honest
    jsonb_build_object('name','revenue','steps', jsonb_build_array(
      jsonb_build_object('step','application_start','step_order',1,'identity_domain','application_id','count_source','applications','visitors',(SELECT count(*) FROM applications WHERE created_at >= now()-interval '30 days')),
      jsonb_build_object('step','doc_upload','step_order',2,'identity_domain','application_id','count_source','application_documents','visitors',(SELECT count(distinct application_id) FROM application_documents WHERE created_at >= now()-interval '30 days')),
      jsonb_build_object('step','application_submitted','step_order',3,'identity_domain','visitor_id','count_source','events','visitors',(SELECT count(distinct visitor_id) FROM events WHERE created_at >= _cutover AND COALESCE(traffic_class,'real') IN ('real','known_real') AND COALESCE(is_admin,false)=false AND COALESCE(is_test,false)=false AND created_at >= now()-interval '30 days' AND name = 'application_submitted')),
      jsonb_build_object('step','payment_start','step_order',4,'identity_domain','visitor_id','count_source','events','visitors',(SELECT count(distinct visitor_id) FROM events WHERE created_at >= _cutover AND COALESCE(traffic_class,'real') IN ('real','known_real') AND COALESCE(is_admin,false)=false AND COALESCE(is_test,false)=false AND created_at >= now()-interval '30 days' AND name = 'payment_start')),
      jsonb_build_object('step','payment_complete','step_order',5,'identity_domain','visitor_id','count_source','events','visitors',(SELECT count(distinct visitor_id) FROM events WHERE created_at >= _cutover AND COALESCE(traffic_class,'real') IN ('real','known_real') AND COALESCE(is_admin,false)=false AND COALESCE(is_test,false)=false AND created_at >= now()-interval '30 days' AND name = 'payment_complete')),
