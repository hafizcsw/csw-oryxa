...
-- Fix: Add geo_source to university RPCs and remove LIMIT 30
...
AS $$
  ...
  GROUP BY v.university_id, v.university_name_ar, v.university_name_en, v.university_logo, v.city,
           u.geo_lat, u.geo_lon, u.geo_source, u.has_dorm, u.dorm_lat, u.dorm_lon, u.dorm_address, u.dorm_price_monthly_local, u.dorm_currency_code
