...
-- إضافة عمود name_ar لجدول universities
ALTER TABLE public.universities ADD COLUMN IF NOT EXISTS name_ar TEXT;

-- حذف الـ View وإعادة إنشائه مع الأعمدة الجديدة
