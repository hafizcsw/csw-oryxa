-- Add cron job for popularity rollup (runs daily at 02:20)
select cron.schedule(
  'rollup-popularity-daily',
  '20 2 * * *',
  $$
  select net.http_post(
    url:='https://alkhaznaqdlxygeznapt.supabase.co/functions/v1/search-rollup-popularity',
