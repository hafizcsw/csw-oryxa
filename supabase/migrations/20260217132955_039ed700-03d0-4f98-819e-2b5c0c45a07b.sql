...
-- Fix COALESCE: treat NULL is_active as active (matching public views behavior)
DROP FUNCTION IF EXISTS public.admin_list_universities(text, uuid, boolean, boolean, integer, integer);
