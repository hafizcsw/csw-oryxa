...
CREATE POLICY "crawler_runs_service_full" ON public.crawler_runs FOR ALL USING (true) WITH CHECK (true);
CREATE TRIGGER trg_crawler_runs_updated_at BEFORE UPDATE ON public.crawler_runs FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE POLICY "crawler_run_items_service_full" ON public.crawler_run_items FOR ALL USING (true) WITH CHECK (true);
CREATE TRIGGER trg_crawler_run_items_updated_at BEFORE UPDATE ON public.crawler_run_items FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE POLICY "crawler_targets_service_full" ON public.crawler_targets FOR ALL USING (true) WITH CHECK (true);
CREATE TRIGGER trg_crawler_targets_updated_at BEFORE UPDATE ON public.crawler_targets FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE POLICY "crawler_locks_service_full" ON public.crawler_locks FOR ALL USING (true) WITH CHECK (true);
...
CREATE TABLE public.crawler_telemetry (
  ...
  stage text NOT NULL,
  event_type text NOT NULL CHECK (event_type IN ('started','completed','failed','warning','metric')),
...
CREATE POLICY "crawler_telemetry_service_full" ON public.crawler_telemetry FOR ALL USING (true) WITH CHECK (true);
...
CREATE TABLE public.evidence_items (
  ...
  university_id uuid NOT NULL REFERENCES public.universities(id) ON DELETE CASCADE,
  entity_type text NOT NULL CHECK (entity_type IN ('university','program','housing','media','leadership','research','country')),
  entity_id uuid NULL,
  entity_match_status text NOT NULL DEFAULT 'pending' CHECK (entity_match_status IN ('pending','matched','ambiguous','no_match','manual_review')),
  ...
  trust_level text NOT NULL DEFAULT 'unverified' CHECK (trust_level IN ('official','verified','inferred','unverified')),
  contextual_only boolean NOT NULL DEFAULT false,
  freshness_date timestamptz NULL,
  extraction_method text NOT NULL CHECK (extraction_method IN ('static_fetch','rendered_fetch','pdf_parse','ai_extraction','regex_extraction','sitemap_discovery','manual_entry')),
  ...
  review_status text NOT NULL DEFAULT 'pending' CHECK (review_status IN ('pending','verified','rejected','needs_revision','contextual')),
  publish_status text NOT NULL DEFAULT 'unpublished' CHECK (publish_status IN ('unpublished','published','superseded','deleted')),
...
CREATE POLICY "evidence_items_service_full" ON public.evidence_items FOR ALL USING (true) WITH CHECK (true);
CREATE TRIGGER trg_evidence_items_updated_at BEFORE UPDATE ON public.evidence_items FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TABLE public.evidence_validation_rules (
  ...
  fact_group text NOT NULL,
  field_key text NOT NULL,
  validation_type text NOT NULL CHECK (validation_type IN ('regex_pattern','value_range','value_list','url_pattern','date_range','entity_lookup','cross_field','ai_verification')),
...
CREATE POLICY "evidence_validation_rules_service_full" ON public.evidence_validation_rules FOR ALL USING (true) WITH CHECK (true);
...
CREATE TABLE public.publish_audit_trail (
  ...
  action text NOT NULL CHECK (action IN ('publish','reject','delete_run_output','supersede')),
...
CREATE POLICY "publish_audit_trail_service_full" ON public.publish_audit_trail FOR ALL USING (true) WITH CHECK (true);
...
CREATE TABLE public.program_curriculum_draft (
  ...
  curriculum_type text NOT NULL CHECK (curriculum_type IN ('module','course','internship','capstone','project','requirement','elective','specialization')),
...
CREATE POLICY "program_curriculum_draft_service_full" ON public.program_curriculum_draft FOR ALL USING (true) WITH CHECK (true);
...
CREATE POLICY "housing_draft_service_full" ON public.housing_draft FOR ALL USING (true) WITH CHECK (true);
CREATE TRIGGER trg_housing_draft_updated_at BEFORE UPDATE ON public.housing_draft FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE POLICY "housing_price_draft_service_full" ON public.housing_price_draft FOR ALL USING (true) WITH CHECK (true);
...
CREATE POLICY "housing_media_draft_service_full" ON public.housing_media_draft FOR ALL USING (true) WITH CHECK (true);
...
CREATE POLICY "leadership_draft_service_full" ON public.leadership_draft FOR ALL USING (true) WITH CHECK (true);
CREATE TRIGGER trg_leadership_draft_updated_at BEFORE UPDATE ON public.leadership_draft FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE POLICY "media_draft_service_full" ON public.media_draft FOR ALL USING (true) WITH CHECK (true);
CREATE TRIGGER trg_media_draft_updated_at BEFORE UPDATE ON public.media_draft FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE POLICY "orx_mapping_rules_service_full" ON public.orx_mapping_rules FOR ALL USING (true) WITH CHECK (true);