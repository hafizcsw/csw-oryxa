...
DECLARE
  ...
  _f text := 'AND COALESCE(traffic_class,''real'') IN (''real'',''known_real'') AND COALESCE(is_admin,false)=false AND COALESCE(is_test,false)=false AND COALESCE(is_staff,false)=false';
BEGIN
