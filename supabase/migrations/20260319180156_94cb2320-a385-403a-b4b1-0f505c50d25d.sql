-- Promotion RPC: move clean program-scoped admissions/deadlines observations to program_draft
...
DECLARE
  ...
  rec record;
BEGIN
  -- Iterate over distinct program-scoped admissions/deadlines observations
  FOR rec IN
  ...
  LOOP
    -- Gather best observation per field for this program
    DECLARE
    ...
    BEGIN
      ...
      BEGIN
        ...
        ON CONFLICT (university_id, title, source_url)
          DO UPDATE SET
